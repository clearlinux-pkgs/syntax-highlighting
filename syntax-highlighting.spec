...
Version  : 6.6.0
Release  : 88
URL      : https://download.kde.org/stable/frameworks/6.6/syntax-highlighting-6.6.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.6/syntax-highlighting-6.6.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.6/syntax-highlighting-6.6.0.tar.xz.sig
...
%setup -q -n syntax-highlighting-6.6.0
cd %{_builddir}/syntax-highlighting-6.6.0
pushd ..
cp -a syntax-highlighting-6.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726434299
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6SyntaxHighlighting.so.6.6.0
...
/usr/lib64/libKF6SyntaxHighlighting.so.6.6.0
