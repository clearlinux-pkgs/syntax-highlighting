...
Version  : 5.100.0
Release  : 58
URL      : https://download.kde.org/stable/frameworks/5.100/syntax-highlighting-5.100.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.100/syntax-highlighting-5.100.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/syntax-highlighting-5.100.0.tar.xz.sig
...
%prep
%setup -q -n syntax-highlighting-5.100.0
cd %{_builddir}/syntax-highlighting-5.100.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668440194
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/syntax-highlighting-%{version}/src/quick/qmldir.license %{buildroot}/usr/share/package-licenses/syntax-highlighting/12bd786cf1d4af3d5767315038df2141eb66c02a || :
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5SyntaxHighlighting.so.5.100.0
